...
addLayer("e", {
    ...
    effectDescription() { return `multiplying productivity by ${player[this.layer].points.add(1)} and delaying the productivity slow down by ${player[this.layer].points * 2} hours` },
    roundUpCost: true,
